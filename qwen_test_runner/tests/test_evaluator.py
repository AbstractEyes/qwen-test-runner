...
This catches metric bugs BEFORE we spend GPU time. Run with `python -m tests.test_evaluator`.
"""
...
from src.evaluator import parse_safely, score_sample, score_run
from src.schema import Caption
